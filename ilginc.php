...
<div class="ilginc-bg">
<h1 class="greeting-title">Dikkat Çeken</h1>
<p class="greeting-bottom-title">Birbirinden ilginç tamamıyla farklı görüntüler</p>
</div>

<div class="gallery-design">
        <?php
            
            $show = $conn->prepare("SELECT * FROM resimler WHERE kategoriName = 'ilginc'");
            $show->execute();
