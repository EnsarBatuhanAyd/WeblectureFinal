...
<div class="sehirler-bg">
<h1 class="greeting-title">Muhteşem Şehirler</h1>
<p class="greeting-bottom-title">Farklı ve kültür kokan en güzel şehirler</p>
</div>
<div class="gallery-design">
        <?php
            
            $show = $conn->prepare("SELECT * FROM resimler WHERE kategoriName = 'sehirler'");
            $show->execute();
